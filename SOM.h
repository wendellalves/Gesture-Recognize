...
public:
    ...
    void findWinner(Sample *s, int &i, int &j); // Node n
    //Node* findNodeWinner(Sample *s);
    ...
    void loadNetwork(std::string csvFileName, int sizeNet);
    void loadNetworkAruco(std::string csvFileName, int sizeNetwork);
